...
def model_eval_sts_simcse(dataloader, model, device):
...
def model_eval_sst_simcse(dataloader, model, device):
    with torch.no_grad():
        sst_y_true = []
        sst_y_pred = []
        sst_sent_ids = []
...
def test_model_multitask(args, model, device, tokenizer):
        ...
        sst_test_data = SentenceClassificationTestDataset(sst_test_data, args, tokenizer)
        ...
        para_test_data = SentencePairTestDataset(para_test_data, args, tokenizer)
        ...
        sts_test_data = SentencePairTestDataset(sts_test_data, args, tokenizer)
